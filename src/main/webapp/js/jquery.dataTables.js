...
(/** @lends <global> */function( $ ) {
	...
	var gshow = "Show";
	var gsearch = "Filter";
	var gshowing = "Showing";
	var gentries = "entries";
	var gfirst = "First";
	var gprevious = "Previous";
	var gnext = "Next";
	var glast = "Last";
	var DataTable;
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": gshowing+" _START_ to _END_ of _TOTAL_ "+gentries,
			 ...
			 *    } );
			 */
			"sInfoEmpty": gshowing+" 0 to 0 of 0 "+gentries,
